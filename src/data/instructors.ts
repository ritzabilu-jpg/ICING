...
export const INSTRUCTORS: Instructor[] = [
  {
    ...
    bio: 'פיזיותרפיסט מ-2001, מדריך קורס מדריכי טבילה במי קרח. מעביר סדנאות לכולם, גם למקומות עבודה בכל מקום, יחד עם הצוות',
    specialties: ['גיבוש צוותים', 'הדרכת חוסן מנטלי', 'קורס מדריכים'],
    certifications: ['פיזיותרפיסט מוסמך', 'CWI Group Instructor', 'מנחה קורס מדריכים'],
