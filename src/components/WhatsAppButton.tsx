...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group flex items-center gap-0 hover:gap-2
                 bg-slate-700 hover:bg-slate-600 text-white
                 p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl hover:rounded-full"
    >
      ...
      <span className="max-w-0 overflow-hidden group-hover:max-w-[8rem] whitespace-nowrap transition-all duration-300 text-sm font-bold">
        שאל שאלה
      </span>
    </a>
  );
