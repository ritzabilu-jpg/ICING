  ...
  return (
    <div className="py-16">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="mt-10 bg-navy-900 rounded-3xl p-6 md:p-8 text-center">
          <p className="text-white font-bold text-lg mb-3">
            מעניין אותך להיות מדריך מוסמך CWI?
          </p>
          <p className="text-slate-400 text-sm mb-5">צור קשר עם</p>
          <a
            href="https://wa.me/972524500825"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 bg-green-500 hover:bg-green-600 text-white font-bold px-6 py-3 rounded-2xl text-sm transition-all hover:scale-105 shadow-lg shadow-green-500/30"
          >
