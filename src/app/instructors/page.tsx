...
const DEMO_INSTRUCTORS: Instructor[] = [
  ...
  },
  {
    ...
    name: 'אמיר שלום',
    photo_url: null,
    bio: 'לשעבר קצין ייחודי, היום מדריך חוסן מנטלי לצוותי עבודה. מתמחה בגיבוש קבוצות ובניית ביטחון עצמי קולקטיבי.',
    specialties: ['גיבוש צוותים', 'חוסן מנטלי', 'מנהיגות'],
    certifications: ['CWI Group Instructor', 'קורס מנחה קבוצות'],
    quote: 'חוסן לא בנוי ברגעי נוחות. הוא נבנה בדיוק ברגעים כאלה.',
  },
];
