        ...
        <div className="bg-ice-50 rounded-3xl border-2 border-ice-100 p-8 md:p-10">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-6 pt-5 border-t border-ice-200 text-center flex flex-wrap items-center justify-center gap-3">
              <span className="text-slate-500 text-xs">מעניין אותך ללמוד להיות מדריך מוסמך ב־CWI? בדוק התאמה כאן</span>
              <a
                href="https://wa.me/972524500825"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center bg-green-500 hover:bg-green-600 text-white p-1.5 rounded-lg transition-all"
                aria-label="WhatsApp"
              >
