...
const workshopTypes = [
  ...
  },
  {
    ...
    description:
      'גיבוש צוות עוצמתי ובניית חוסן מנטלי קבוצתי. ' +
...
const agendaSteps = [
  ...
  { time: '35 דק\'', icon: '🧊', title: 'טבילה מודרכת', description: 'טבילות בליווי מדריך צמוד, 3-5 דקות ב-5°C' },
  { time: '15 דק\'', icon: '☕', title: 'התחממות ושיתוף', description: 'התחממות הדרגתית, שתייה חמה, שיתוף חוויות בקבוצה' },
  { time: '5 דק\'', icon: '📸', title: 'סיכום והכוונה להמשך', description: 'הנחיות להמשך היום, צילום קבוצתי לזיכרון' },
];
