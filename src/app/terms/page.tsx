        ...
        <section className="mb-10">
          ...
          <div className="bg-ice-50 border border-ice-200 rounded-xl p-4">
            <p className="text-slate-700 text-sm leading-relaxed">
              📌 בהתאם לסעיף 14ג לחוק הגנת הצרכן, עסקה שנוצרה מרחוק (טלפון/אינטרנט) ניתנת לביטול תוך 14 ימים
              מיום ביצוע העסקה, ובלבד שהסדנה לא התקיימה. במקרה של ביטול כאמור, יוחזר הסכום בניכוי דמי ביטול
              בגובה 5% מסכום העסקה או ₪100 – לפי הנמוך מביניהם.
            </p>
          </div>
        </section>
